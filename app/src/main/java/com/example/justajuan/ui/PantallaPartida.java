...
public class PantallaPartida extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConstraintLayout fondo = findViewById(R.id.fondoPantallaRol);
        switch (getRol().toString()){

            case "HERRERO":
                fondo.setBackground(getDrawable(R.drawable.fondoherrero));
                break;
            case "CURANDERO":
                fondo.setBackground(getDrawable(R.drawable.fondocurandera));
                break;
            case "MAESTRO_CUADRAS":
                fondo.setBackground(getDrawable(R.drawable.fondomaestrocuadras));
                break;
            case "DRUIDA":
                fondo.setBackground(getDrawable(R.drawable.fondodruida));
                break;
            case "CABALLERO":
                fondo.setBackground(getDrawable(R.drawable.fondocaballero));
                break;
        ...
        botonDesplAcciones.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final Dialog acciones = new Dialog(PantallaPartida.this);
        ...
        botonDesplDiario.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                firebaseDatabase.getReference().child("Diario").child(getCodigoSala()).child(getRol().toString()).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
        ...
        listenerMateriales = databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    ...
                    if (material.getRol().contains(getRol().toString())) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.getValue(Integer.class) != 0) {
                    ...
                    if (snapshot.getValue(Integer.class) == 1) {
                        ...
                        if (numRonda != 5) {
                            Intent i = new Intent(PantallaPartida.this, ResultadosMaestroCuadras.class);
                            ...
                            Intent i = new Intent(PantallaPartida.this, PantallaCuestionario.class);
                            i.putExtra("codigo", getCodigoSala());
                            i.putExtra("listaObjetos", getListaObjetos());
                            i.putExtra("objetosCreandose", objetosCreandose);
